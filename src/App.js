      ...
      <body class="body-font">
        ...
        <section className=" section flexbox-container has-background-black">
          <div className="flexbox-item flexbox-item-1 devicons has-text-white has-background-black">
            <div class="devicon-div"><i class="devicon-html5-plain"></i></div>
            <div class="devicon-div"><i class="devicon-css3-plain"></i></div>
            <div class="devicon-div"><i class="devicon-javascript-plain"></i></div>
            <div class="devicon-div"><i class="devicon-bulma-plain"></i></div>
            <div class="devicon-div"><i class="devicon-git-plain"></i></div>
            <div class="devicon-div"><i class="devicon-nodejs-plain"></i></div>
            <div class="devicon-div"><i class="devicon-react-original"></i></div>
            <div class="devicon-div"><i class="devicon-github-original"></i></div>
            <div class="devicon-div"><i class="devicon-python-plain"></i></div>
            <div class="devicon-div"><i class="devicon-mongodb-plain"></i></div>
            <div class="devicon-div"><i class="devicon-express-original"></i></div>
            <div class="devicon-div"><i class="devicon-django-plain"></i></div>
            <div class="devicon-div"><i class="devicon-postgresql-plain"></i></div>
            <div class="devicon-div"><i class="devicon-npm-original-wordmark"></i></div>
            <div class="devicon-div"><i class="devicon-vscode-plain"></i></div>
            <div class="devicon-div"><i class="devicon-sass-original"></i></div>
            <div class="devicon-div"><i class="devicon-jquery-plain"></i></div>
            <div class="devicon-div"><i class="devicon-heroku-original"></i></div>
            <div class="devicon-div"><i class="devicon-trello-plain"></i></div>
          </div>
...
<h2 className="box has-text-centered">These projects were created during my time on the General Assembly Software Engineering Immersive course. Hover over each project to discover more about it, and click to visit!</h2>
          ...
          <div className="flexbox-container-projects">
              ...
              <a href="https://tdore92.github.io/project-1/" alt="MS Link" target="_blank" rel="noopener noreferrer">
                ...
                <div className="column">
                  ...
                  <div className="image is-1by1 img__wrap grow">
                    <img class="img__img project-images is-rounded" src="https://i.imgur.com/WlwChmr.png" alt="Click Here!" />
                ...
                <div className="">
                  <div className="column">
                    ...
                    <div className="img__wrap image is-1by1 grow">
                      <img class="img__img project-images is-rounded" src="https://i.imgur.com/XdQ5x0g.png" alt="Click Here!" />
                      <div class="img__description_layer">
            ...
            <div className="">
              <div className="column">
                ...
                <div className="img__wrap image is-1by1 grow">
                  <img class="img__img project-images is-rounded" src="https://i.imgur.com/RAvdPV4.png?1" alt="Click Here!" />
                  <div class="img__description_layer">
            ...
            <div className="">
              <div className="column">
                ...
                <div className="image is-1by1 img__wrap grow">
                  <img class="img__img project-images is-rounded" src="https://i.imgur.com/I22et98.png" alt="Click Here!" />
                  <div class="img__description_layer">
                    <p className="img__description has-text-centered">Dinosaur Petshop</p>
                  </div>
                </div>
              </div>
        ...
        <section className="section has-background-black has-text-white">
          ...
          <div className="columns">
            ...
            <div className="column is-one-fifth has-text-centered interests-box">
